...
add_image_size( 'benefits', 82,82 );
add_image_size( 'proud-slider', 390,400, true );
add_image_size( 'master-preview', 181,181, true );
add_image_size( 'product-preview', 232,160, true );
add_image_size( 'testimonial-photo', 452,452, true );
